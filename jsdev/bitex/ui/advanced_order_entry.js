 ...
 */
bitex.ui.AdvancedOrderEntry.prototype.setAmountCurrency = function(sign, code, pip, number_of_decimals, description){
  var dom  = this.getDomHelper();
  ...
  var elements = dom.getElementsByClass(goog.getCssName(this.getBaseCssClass(), 'amount-description'), this.getElement());
  goog.array.forEach(elements, function(el){
    goog.dom.setTextContent(el, description);
  });
  ...
  this.getModel().cryptocurrencydescription = description;
};
