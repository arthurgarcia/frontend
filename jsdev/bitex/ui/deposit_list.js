          ...
          case 'CRY':
            ...
            if (rowSet['Currency'] == 'BTC') {
              ...
              if (goog.isDefAndNotNull(rowSet['Data']['InputAddress'])){
                switch (rowSet['Data']['InputAddress'][0]) {
                  case 'N':
                    blockchain_address = 'https://explorer.nickel.io/address/' + rowSet['Data']['InputAddress'];
                }
              }
            ...
            if (rowSet['Currency'] == 'NKL') {

              var blockchain_address = 'https://explorer.nickel.io/address/' + rowSet['Data']['InputAddress'];
