...
/*
added by tuk
  if (msg["Symbol"].split(":").length > 1) {
    msg["Symbol"] = msg["Symbol"].split(":")[1];
  }
*/
...
bitex.app.BlinkTrade.prototype.adjustBrokerData_ = function(broker_info) {
  ...
  allowed_markets['BTCUSD'] = {'market':"BLINK",'symbol':"BTCUSD",'description': "BTC / USD"};
  allowed_markets['NKLBTC'] = {'market':"BLINK",'symbol':"NLKBTC",'description': "NKL / BTC"};
